...
const SettingsPage: React.FC = () => {
  const { settings, updateSettings, resetSettings, savedFlash } = useSettings();
    // Provide sensible defaults to avoid undefined errors during initial render
    const defaultSettings = {
      alertTimings: [],
      alertType: 'banner',
      alertSound: false,
      repeatAlert: false,
      repeatIntervalMins: 2,
      syncFrequencyMins: 0,
      lookaheadDays: 7,
      autoLogMeetings: false,
    ...
    // Use mergedSettings throughout the component instead of raw settings
  ...
  const handleUpdateAccount = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5001'}/api/user/update`, {
        method: 'POST',
        headers: {
  ...
  const toggleAlertTiming = (mins: number) => {
    const next = mergedSettings.alertTimings.includes(mins)
      ? mergedSettings.alertTimings.filter(t => t !== mins)
      : [...mergedSettings.alertTimings, mins].sort((a, b) => a - b);
            ...
            <SectionCard icon="🔔" title="Notifications &amp; Alerts" id="stg-notifications">
              ...
              <div className="stg-field">
                ...
                <div className="stg-chip-group">
                  {ALERT_OPTIONS.map(mins => (
                    <button
                      key={mins}
                      className={`stg-chip ${mergedSettings.alertTimings.includes(mins) ? 'active' : ''}`}
              ...
              <SettingsRow
                ...
                control={
                  <select
                    ...
                    value={mergedSettings.alertType}
              ...
              <SettingsRow
                ...
                control={
                  <Toggle
                    id="alert-sound"
                    checked={mergedSettings.alertSound}
              ...
              <SettingsRow
                ...
                control={
                  <Toggle
                    id="repeat-alert"
                    checked={mergedSettings.repeatAlert}
                    onChange={v => updateSettings({ repeatAlert: v })}
                  />
                }
              />

              {mergedSettings.repeatAlert && (
                <SettingsRow
                  ...
                  control={
                    <select
                      className="stg-select"
                      value={mergedSettings.repeatIntervalMins}
            ...
            <SectionCard icon="📅" title="Calendar" id="stg-calendar">
              ...
              <SettingsRow
                ...
                control={
                  <select
                    className="stg-select"
                    value={mergedSettings.syncFrequencyMins}
              ...
              <SettingsRow
                ...
                control={
                  <select
                    className="stg-select"
                    value={mergedSettings.lookaheadDays}
            ...
            <SectionCard icon="📋" title="Event Recording" id="stg-recording">
              ...
              <SettingsRow
                ...
                control={
                  <Toggle
                    id="auto-log"
                    checked={mergedSettings.autoLogMeetings}
              ...
              <SettingsRow
                ...
                control={
                  <select
                    className="stg-select"
                    value={mergedSettings.historyRetentionDays}
            ...
            <SectionCard icon="👤" title="Profile" id="stg-profile">
              ...
              <div className="stg-field">
                ...
                <input
                  ...
                  value={mergedSettings.displayName}
            ...
            <SectionCard icon="🎨" title="Theme Settings" id="stg-theme">
              <SettingsRow
                ...
                control={
                  <select
                    className="stg-select"
                    value={mergedSettings.theme || 'dark'}
